...
public class MinHeap {
    ...
    public MNode finding(int des, int s){
        MNode found = root;
        String findParents = "";
            int i = s;
            while(root != null && i > 1) {
            ...
            while (findParents.length() != 0) {
                ...
                findParents = findParents.substring(1);
            }
            if (found.getTo() == des) {
                return found;
            }
            else{
                return finding(des, s-1);
        }
    }
    public MNode findMN(int des) {
        return finding(des, size);
    }
}
